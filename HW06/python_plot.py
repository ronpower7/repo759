...
plt.figure(figsize=(10, 6))
plt.plot(x_values, y_values1, marker='o', color='b', linestyle='-',label='1024 threads')
plt.plot(x_values, y_values2, marker='s', color='r', linestyle='--',label='256 threads')
...
plt.ylabel('Time taken by matmul function', fontsize=12)
plt.title('Plot of time taken by matmul by using  CUDA threads (1024 and 256 threads per block)', fontsize=14)

# Show legend and grid
plt.legend()
plt.grid(True, which='both', linestyle='--', linewidth=0.5)

plt.savefig('/filespace/k/kundu8/Desktop/repo759/HW06/task1.pdf')
